...
def test_login_with_correct_credentials_returns_token(client_with_seeded_user):
    response = client_with_seeded_user.post(
...
def test_login_with_wrong_password_is_rejected(client_with_seeded_user):
    response = client_with_seeded_user.post(
...
def test_authenticated_endpoint_rejects_missing_token(client_with_seeded_user):
    ...
    response = client_with_seeded_user.get("/api/v1/auth/login")
